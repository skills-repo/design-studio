...
| 环节 | 技能 | 描述 |
|------|------|------|
| 🏗️ 设计系统 | `design-system` | CSS 变量体系、组件 token、主题切换 |
| 👁️ 界面审查 | `ui-review` | UI 一致性和可用性审查，发现布局/交互问题 |
| ♿ 可访问性 | `accessibility` | WCAG 审查、颜色对比度、键盘导航、屏幕阅读器 |
| 🎬 动效 | `motion-design` | CSS/JS 动画建议，过渡效果与微交互 |
